...
Feature: Create new pet prospect
  ...
  Scenario Outline: Create a pet corresponding to a prospect in platform
    ...
    Examples:
      |type       |country|postalCode|state|email   |status_code|name        |petType|DOB       |
      |INDIVIDUAL |USA    |95005     |PH   |random  |201        |Martin      |dog    |2020-01-01|
      |INDIVIDUAL |USA    |95005     |PH   |random  |201        |Martin      |cat    |2020-01-01|
